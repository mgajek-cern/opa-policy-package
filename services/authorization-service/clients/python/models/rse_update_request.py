...
if TYPE_CHECKING:
  ...
  from ..models.rse_update_request_changes import RseUpdateRequestChanges
...
T = TypeVar("T", bound="RseUpdateRequest")



@_attrs_define
class RseUpdateRequest:
    """
        Attributes:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        from ..models.rse_update_request_changes import RseUpdateRequestChanges # noqa: PLC0415
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        changes = RseUpdateRequestChanges.from_dict(d.pop("changes"))
        ...
        rse_update_request.additional_properties = d
        return rse_update_request
