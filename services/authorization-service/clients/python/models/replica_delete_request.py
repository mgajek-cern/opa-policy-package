...
T = TypeVar("T", bound="ReplicaDeleteRequest")



@_attrs_define
class ReplicaDeleteRequest:
    """
        Attributes:
            ...
            rse (Rse):
            files (list[Did]): The files whose replicas are deleted. A replica's ownership is its DID's.
            context (Context):
     """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        replica_delete_request.additional_properties = d
        return replica_delete_request
