...
if TYPE_CHECKING:
  ...
  from ..models.rse_attribute_set_request_attribute import RseAttributeSetRequestAttribute
...
T = TypeVar("T", bound="RseAttributeSetRequest")



@_attrs_define
class RseAttributeSetRequest:
    """
        Attributes:
            ...
            rse (Rse):
            attribute (RseAttributeSetRequestAttribute):
            context (Context):
     """
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        from ..models.rse_attribute_set_request_attribute import RseAttributeSetRequestAttribute # noqa: PLC0415
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        attribute = RseAttributeSetRequestAttribute.from_dict(d.pop("attribute"))
        ...
        rse_attribute_set_request.additional_properties = d
        return rse_attribute_set_request
