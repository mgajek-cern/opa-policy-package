...
import rucio_authz_client.models
from rucio_authz_client import rest
from rucio_authz_client.configuration import Configuration
from rucio_authz_client.exceptions import ApiException, ApiValueError
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(rucio_authz_client.models, klass)
