...
SCHEME_MAP = {
    "srm": ["srm", "gsiftp"],
    "gsiftp": ["srm", "gsiftp"],
    "https": ["https", "http", "davs", "srm+https", "root"],
    "davs": ["https", "http", "davs", "srm+https"],
...
SUPPORTED_PROTOCOLS_LITERAL = Literal[
    "gsiftp",
    "srm",
    "root",
    "davs",
...
RSE_BASE_SUPPORTED_PROTOCOL_OPERATIONS: list[str] = list(
    get_args(RSE_BASE_SUPPORTED_PROTOCOL_OPERATIONS_LITERAL)
)

RSE_ALL_SUPPORTED_PROTOCOL_OPERATIONS_LITERAL = Literal[
    RSE_BASE_SUPPORTED_PROTOCOL_OPERATIONS_LITERAL,
    "third_party_copy_read",
    "third_party_copy_write",
]
RSE_ALL_SUPPORTED_PROTOCOL_OPERATIONS: list[str] = list(
    get_args(RSE_ALL_SUPPORTED_PROTOCOL_OPERATIONS_LITERAL)
)
...
FTS_JOB_TYPE = namedtuple(
    "FTS_JOB_TYPE", ["MULTIPLE_REPLICA", "MULTI_HOP", "SESSION_REUSE", "REGULAR"]
)("R", "H", "Y", "N")
...
POLICY_ALGORITHM_TYPES_LITERAL = Literal[
