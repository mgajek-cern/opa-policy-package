...
#     passes the convention. This is the only rule that distinguishes a
#     mapped non-admin entitlement from an account with no entitlements.
...
#
# data.vo.entitlement_policy maps URN entitlements to privilege levels.
